...
contract('ChainList', function(accounts){
    ...
    it("should buy the first article", function(){
        return ChainList.deployed().then(function(instance){
            ...
            // sellerBalanceBeforeBuy = web3.utils.fromWei(BigInt(web3.eth.getBalance(seller)), 'ether');
            // buyerBalanceBeforeBuy = web3.utils.fromWei(BigInt(web3.eth.getBalance(buyer)), 'ether');
            ...
            // sellerBalanceAfterBuy = Number(web3.utils.fromWei(JSON.stringify(web3.eth.getBalance(seller)), 'ether'));
            // buyerBalanceAfterBuy = Number(web3.utils.fromWei(JSON.stringify(web3.eth.getBalance(buyer)), 'ether'));
